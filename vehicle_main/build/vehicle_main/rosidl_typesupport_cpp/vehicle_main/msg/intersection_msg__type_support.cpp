...
static const _IntersectionMsg_type_support_symbol_names_t _IntersectionMsg_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, vehicle_main, msg, IntersectionMsg)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, vehicle_main, msg, IntersectionMsg)),
  }
};
...
{
  return &::vehicle_main::msg::rosidl_typesupport_cpp::IntersectionMsg_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, vehicle_main, msg, IntersectionMsg)() {
  return get_message_type_support_handle<vehicle_main::msg::IntersectionMsg>();
}
