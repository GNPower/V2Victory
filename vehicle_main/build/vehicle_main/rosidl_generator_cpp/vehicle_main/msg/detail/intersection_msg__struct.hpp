...
#ifndef VEHICLE_MAIN__MSG__DETAIL__INTERSECTION_MSG__STRUCT_HPP_
#define VEHICLE_MAIN__MSG__DETAIL__INTERSECTION_MSG__STRUCT_HPP_
...
#ifndef _WIN32
# define DEPRECATED__vehicle_main__msg__IntersectionMsg __attribute__((deprecated))
#else
# define DEPRECATED__vehicle_main__msg__IntersectionMsg __declspec(deprecated)
#endif
...
struct IntersectionMsg_
{
  using Type = IntersectionMsg_<ContainerAllocator>;

  explicit IntersectionMsg_(rosidl_runtime_cpp::MessageInitialization _init = rosidl_runtime_cpp::MessageInitialization::ALL)
  {
  ...
  explicit IntersectionMsg_(const ContainerAllocator & _alloc, rosidl_runtime_cpp::MessageInitialization _init = rosidl_runtime_cpp::MessageInitialization::ALL)
  : directions(_alloc)
  {
    if (rosidl_runtime_cpp::MessageInitialization::ALL == _init ||
      rosidl_runtime_cpp::MessageInitialization::ZERO == _init)
  ...
  // pointer types
  using RawPtr =
    vehicle_main::msg::IntersectionMsg_<ContainerAllocator> *;
  using ConstRawPtr =
    const vehicle_main::msg::IntersectionMsg_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<vehicle_main::msg::IntersectionMsg_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<vehicle_main::msg::IntersectionMsg_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      vehicle_main::msg::IntersectionMsg_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<vehicle_main::msg::IntersectionMsg_<ContainerAllocator>, Deleter>;
  ...
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<vehicle_main::msg::IntersectionMsg_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<vehicle_main::msg::IntersectionMsg_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<vehicle_main::msg::IntersectionMsg_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__vehicle_main__msg__IntersectionMsg
    std::shared_ptr<vehicle_main::msg::IntersectionMsg_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__vehicle_main__msg__IntersectionMsg
    std::shared_ptr<vehicle_main::msg::IntersectionMsg_<ContainerAllocator> const>
  ...
  bool operator==(const IntersectionMsg_ & other) const
  {
...
using IntersectionMsg =
  vehicle_main::msg::IntersectionMsg_<std::allocator<void>>;
...
#endif  // VEHICLE_MAIN__MSG__DETAIL__INTERSECTION_MSG__STRUCT_HPP_
