...
#include "vehicle_main/msg/detail/intersection__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const vehicle_main::msg::Intersection *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<vehicle_main::msg::Intersection *>(
    untyped_ros_message);
...
{
  return &vehicle_main::msg::typesupport_fastrtps_cpp::_Intersection__handle;
}
