...
#include "vehicle_main/msg/detail/car__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const vehicle_main::msg::Car & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  vehicle_main::msg::Car & ros_message)
{
  // Member: position_x
  cdr >> ros_message.position_x;
...
{
  auto typed_message =
    static_cast<const vehicle_main::msg::Car *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<vehicle_main::msg::Car *>(
    untyped_ros_message);
...
static size_t _Car__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_Car(full_bounded, 0);
}
...
get_message_type_support_handle<vehicle_main::msg::Car>()
{
  return &vehicle_main::msg::typesupport_fastrtps_cpp::_Car__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, vehicle_main, msg, Car)() {
  return &vehicle_main::msg::typesupport_fastrtps_cpp::_Car__handle;
}
